...
<div class="border-login">
 ...
 <form onsubmit="validationlogin()">
    ...
    <div class="row-login">
        <h3>Username</h3>
        <input type="text" name="form-username" id="form-username" placeholder="Your Username" required/>
    </div>
    <div class="row-login">
        <h3>Password</h3>
        <input type="password" name="form-pw" id="form-pw" placeholder="Your Password" required/>
    </div>
    <div class="btsubmit">
        <input id="submit" type="submit" value="LOGIN" />
    </div>
    <div class="row-login">
        <p>Don't have an account yet? <a href="signup.jsp" class="txta-row">Create one here!</a></p>
        <p>Login by admin? <a href="loginadmin.jsp" class="txta-row">Click Here!</a></p>
    </div>
</form>
</div>
