...
<form onsubmit="validationtopupml()">
<div class="border">
    <div class="row-1">
        <div class="column-1">
            
            <img src="image/logoml.jpg" alt="valorant" class="img">
            <H2 class="txth2">Mobile Legend</H2>
        </div>
        <div class="column-2">
            <h2>Top Up Mobile Legend Point</h2>
        ...
        <div class="row-3">
                ...
                <input class="form-text" type="text" id="name-id" name="name-id" placeholder="Enter in-game ID (Contoh: 12345678 (1234))" required/>
