...
<form onsubmit="validationtopupvalo()">
<div class="border">
    <div class="row-1">
        <div class="column-1">
            
            <img src="image/logovalo.jpg" alt="valorant" class="img">
            <H2 class="txth2">Valorant</H2>
        </div>
        <div class="column-2">
            <h2>Top Up Valorant Point</h2>
            <p class="txtp">1. Enter ID</p>
        ...
        <div class="row-3">
                <p class="txtp-2">Player ID</p>
                <input class="form-text" type="text" id="name-id" name="name-id" placeholder="Enter in-game ID (Example: abcd#1234)" required/>
    ...
    <footer>
        ...
        <div class="footer-wrapper">
          <h3>ABOUT US</h3>
          <p>Check our social media on Facebook, Twitter, Linkedin, and Youtube. Don't forget to follow, subscribe, and like our feeds.</p>
